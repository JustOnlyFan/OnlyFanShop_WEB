...
import { ArrowLeft, Search, Box, Check, Package, PackageCheck } from 'lucide-react'
...
export default function WarehouseProductsPage() {
  ...
  const hasChanges = useMemo(() => {
    const originalIds = new Set(allProducts.filter((p) => p.isAvailable === true).map((p) => p.productId))
